# Fixture — 5 jogos para testes (mini-tabela)

Formato igual ao `data/jogos.md`. Cobre Grupo (fase de grupos), Oitavas (mata-mata),
e Final, pra exercitar o multiplicador 2× e ordenação por número.
