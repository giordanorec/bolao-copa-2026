# Reel — Semis J102: Inglaterra × Argentina

**Duração:** 8s · 1080×1920

| t | cena |
|---|---|
| 0.0-2.0s | Capa: badge OITAVAS + bandeiras + confronto Inglaterra VS Argentina |
| 2.0-4.5s | Placar consenso enorme: **1×2** com "52% das 62 IAs cravaram" e badge de força do consenso |
