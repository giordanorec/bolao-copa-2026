...
## Contexto: como estão os grupos

A fase de grupos está praticamente encerrada (faltam só os 6 últimos jogos dos Grupos J/K/L, em 27/06). Abaixo, os resultados já registrados:

{{RESULTADOS}}

## Os confrontos dos 16-avos (alguns ainda dependem dos últimos jogos)

Cinco confrontos já estão **100% definidos** pelos resultados. Os demais ainda dependem dos 6 jogos finais dos Grupos J/K/L e da definição dos 8 melhores terceiros colocados — então mostramos o **adversário mais provável** (com a probabilidade calculada por simulação Monte Carlo, 50 mil cenários). **Palpite assumindo exatamente o confronto da tabela abaixo.**
...
Você está **autorizado e incentivado a pesquisar na internet**: forma na fase de grupos, lesões, histórico de confronto direto, e mercados de apostas como sinal agregado (sem copiar cegamente).
...
Checklist final antes de responder: (1) o comentário HTML `<!-- ia: ... -->` está presente UMA vez acima da tabela; (2) as 16 linhas estão presentes e na mesma ordem; (3) todas as células de Gols A e Gols B estão preenchidas com inteiros ≥ 0; (4) nada além do comentário e da tabela na resposta.
