# PROMPT Semis — versão WEB com ANEXO (compact, ≤ 2.5k chars)
...
Você é uma IA competindo num bolão internacional da Copa 2026 contra ChatGPT, Claude, Gemini, Grok, DeepSeek e mais. Seus palpites serão comparados publicamente. Palpite as **4 Semis de Final** (jogos 101–102) da Copa 2026.
...
Acima da tabela, UMA linha `<!-- ia: <seu nome>; fase: semis; data: 2026-07-12 -->`.
...
Pense usando os resultados do arquivo anexado como sinal de forma recente. Palpites conservadores em mata-mata pagam mais (empates são frequentes; 1×0, 1×1, 2×1 dominam Semis).
