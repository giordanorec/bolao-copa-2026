...
MM_JOGOS = list(range(89, 97))

MAPPING_PATH = ROOT / "config" / "openrouter_mapping.json"
PROMPT_PATH = ROOT / "config" / "prompts" / "ia-palpiteira-oitavas-v1.md"
DOSSIE_PATH = ROOT / "data" / "dossie" / "campeao-2026-07-04.md"
RESULTADOS_PATH = ROOT / "data" / "resultados" / "jogos.md"
PALPITES_DIR = ROOT / "data" / "palpites_oitavas"
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Coleta mata-mata Oitavas (8 jogos 89-96).")
